...
function XMEye() {
    return ( 
        <View style={styles.wrapper}>
            <Image style={styles.eyeImg} source={require('../assets/eyebal.png')} />
            <View style={styles.inputWrapper}>
                ...
                <Image style={[styles.imgInput, styles.imgInput1]} source={require('../assets/iconaccount.png')}/>
                <Image style={[styles.imgInput, styles.imgInput2]} source={require('../assets/lockup.png')}/>
            </View>
            ...
            <View style={styles.socialWrapper}>
                <Image style={styles.socialImg} source={require('../assets/iconaccount.png')} />
                <Image style={styles.socialImg} source={require('../assets/wifi.png')} />
                <Image style={[styles.socialImg, {position: 'relative'}]} source={require('../assets/Rectangle19.png')} />
                <Image style={styles.iconFacebook} source={require('../assets/icofacebook.png')} />
            </View>
        </View>
     );
}
